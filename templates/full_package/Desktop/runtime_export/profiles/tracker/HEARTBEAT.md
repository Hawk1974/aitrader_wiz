# HEARTBEAT.md — Tracker

## Heartbeat Purpose

Run after every submission, then on the configured monitoring cadence until all tracked orders reach terminal or policy-defined stable states.
