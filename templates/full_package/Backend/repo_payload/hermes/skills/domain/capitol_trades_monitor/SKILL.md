---
name: capitol_trades_monitor
description: "Polls Capitol Trades source every 30 minutes when enabled. AI does not poll."
platforms: [windows]
metadata:
  hermes:
    tags: [ai-trader, alpaca, paper-trading, risk, audit]
---
# Skill: capitol_trades_monitor

## Classification

Python-backed deterministic source polling.

## Purpose

Polls Capitol Trades source every 30 minutes when enabled. AI does not poll.
...
- Script: `scripts/integrations/capitol_trades_monitor.py`
- Required CLI args: `--source-policy <path> --poll-interval-minutes 30`
- Required schemas/artifacts: `source_payload_record, script_result_envelope`
