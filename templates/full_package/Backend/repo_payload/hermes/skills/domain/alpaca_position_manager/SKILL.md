---
name: alpaca_position_manager
description: "Captures positions and exposure. Does not submit or modify orders."
platforms: [windows]
metadata:
  hermes:
    tags: [ai-trader, alpaca, paper-trading, risk, audit]
---
# Skill: alpaca_position_manager

## Classification

Python-backed deterministic position snapshot.

## Purpose

Captures positions and exposure. Does not submit or modify orders.
...
- Script: `scripts/integrations/alpaca_position_manager.py`
- Required CLI args: `--broker-mode paper|live --symbols <optional CSV>`
- Required schemas/artifacts: `position_snapshot, script_result_envelope`
