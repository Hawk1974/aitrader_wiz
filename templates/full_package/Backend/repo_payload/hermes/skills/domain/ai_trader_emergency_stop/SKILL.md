---
name: ai_trader_emergency_stop
description: "Activates, reads, or resets emergency stop. Reset requires explicit reason and audit event."
platforms: [windows]
metadata:
  hermes:
    tags: [ai-trader, alpaca, paper-trading, risk, audit]
---
# Skill: ai_trader_emergency_stop

## Classification

Python-backed deterministic emergency state machine.

## Purpose

Activates, reads, or resets emergency stop. Reset requires explicit reason and audit event.
...
- Script: `scripts/trading/ai_trader_emergency_stop.py`
- Required CLI args: `--action status|activate|reset --reason <text> --actor <identity>`
- Required schemas/artifacts: `emergency_stop_state, script_result_envelope`
