---
name: capitol_trades_event_normalizer
description: "Maps raw disclosure data to canonical event records and idempotency keys."
platforms: [windows]
metadata:
  hermes:
    tags: [ai-trader, alpaca, paper-trading, risk, audit]
---
# Skill: capitol_trades_event_normalizer

## Classification

Python-backed deterministic event normalization.

## Purpose

Maps raw disclosure data to canonical event records and idempotency keys.
...
- Script: `scripts/trading/capitol_trades_event_normalizer.py`
- Required CLI args: `--raw-payload <path> --source-policy <path>`
- Required schemas/artifacts: `normalized_trade_event, script_result_envelope`
