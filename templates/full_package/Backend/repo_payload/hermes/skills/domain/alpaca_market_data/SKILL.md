...
description: "Retrieves market/session/tradability context and marks stale data unsafe for trading."
platforms: [windows]
metadata:
  hermes:
    tags: [ai-trader, alpaca, paper-trading, risk, audit]
---
# Skill: alpaca_market_data

## Classification

Python-backed deterministic market context retrieval.

## Purpose

Retrieves market/session/tradability context and marks stale data unsafe for trading.
...
- Script: `scripts/integrations/alpaca_market_data.py`
- Required CLI args: `--symbols <CSV> --max-staleness-seconds <int>`
- Required schemas/artifacts: `market_context, script_result_envelope`
