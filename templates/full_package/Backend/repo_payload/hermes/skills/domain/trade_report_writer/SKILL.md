---
name: trade_report_writer
description: "Writes Markdown reports and manifests from structured artifacts; optional AgentMail delivery if configured."
platforms: [windows]
metadata:
  hermes:
    tags: [ai-trader, alpaca, paper-trading, risk, audit]
---
# Skill: trade_report_writer

## Classification

Python-backed deterministic report writer.

## Purpose

Writes Markdown reports and manifests from structured artifacts; optional AgentMail delivery if configured.
...
- Script: `scripts/reporting/trade_report_writer.py`
- Required CLI args: `--report-type <type> --artifact <path> [--artifact <path>...] --report-policy <path>`
- Required schemas/artifacts: `report_manifest, script_result_envelope`
