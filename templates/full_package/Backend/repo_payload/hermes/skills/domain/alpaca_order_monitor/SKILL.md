---
name: alpaca_order_monitor
description: "Retrieves and reconciles order states with safe handling of unknown/stale orders."
platforms: [windows]
metadata:
  hermes:
    tags: [ai-trader, alpaca, paper-trading, risk, audit]
---
# Skill: alpaca_order_monitor

## Classification

Python-backed deterministic order reconciliation.

## Purpose

Retrieves and reconciles order states with safe handling of unknown/stale orders.
...
- Script: `scripts/integrations/alpaca_order_monitor.py`
- Required CLI args: `--broker-mode paper|live --order-id <optional> --since-utc <optional>`
- Required schemas/artifacts: `order_status, script_result_envelope`
