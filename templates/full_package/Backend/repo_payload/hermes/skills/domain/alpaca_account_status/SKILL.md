...
description: "Checks Alpaca account state for selected mode. Live mode requires live enablement and valid live credentials."
platforms: [windows]
metadata:
  hermes:
    tags: [ai-trader, alpaca, paper-trading, risk, audit]
---
# Skill: alpaca_account_status

## Classification

Python-backed deterministic broker account snapshot.

## Purpose

Checks Alpaca account state for selected mode. Live mode requires live enablement and valid live credentials.
...
- Script: `scripts/integrations/alpaca_account_status.py`
- Required CLI args: `--broker-mode paper|live`
- Required schemas/artifacts: `account_status, script_result_envelope`
