---
name: alpaca_risk_gate
description: "Calculates risk pass/reject. AI cannot approve or override this result."
platforms: [windows]
metadata:
  hermes:
    tags: [ai-trader, alpaca, paper-trading, risk, audit]
---
# Skill: alpaca_risk_gate

## Classification

Python-backed deterministic risk authority.

## Purpose

Calculates risk pass/reject. AI cannot approve or override this result.
...
- Script: `scripts/trading/alpaca_risk_gate.py`
- Required CLI args: `--order-intent <path> --account-status <path> --market-context <path> --risk-policy <path>`
- Required schemas/artifacts: `risk_decision, script_result_envelope`
