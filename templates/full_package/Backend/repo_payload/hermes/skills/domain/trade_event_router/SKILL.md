---
name: trade_event_router
description: "Routes normalized event through analysis, risk, approval, submission, and reporting based on mode and artifacts."
platforms: [windows]
metadata:
  hermes:
    tags: [ai-trader, alpaca, paper-trading, risk, audit]
---
# Skill: trade_event_router

## Classification

Hybrid Hermes orchestration with deterministic routing script.

## Purpose

Routes normalized event through analysis, risk, approval, submission, and reporting based on mode and artifacts.
...
- Script: `scripts/trading/trade_event_router.py`
- Required CLI args: `--normalized-event <path> --route-policy <path>`
- Required schemas/artifacts: `daily_run_state, script_result_envelope`
