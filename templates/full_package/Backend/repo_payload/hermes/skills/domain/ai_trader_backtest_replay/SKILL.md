---
name: ai_trader_backtest_replay
description: "Replays using conservative fill assumptions and never calls broker mutation APIs."
platforms: [windows]
metadata:
  hermes:
    tags: [ai-trader, alpaca, paper-trading, risk, audit]
---
# Skill: ai_trader_backtest_replay

## Classification

Python-backed deterministic replay.

## Purpose

Replays using conservative fill assumptions and never calls broker mutation APIs.
...
- Script: `scripts/replay/ai_trader_backtest_replay.py`
- Required CLI args: `--dataset <path> --replay-policy <path> --start-utc <time> --end-utc <time>`
- Required schemas/artifacts: `backtest_result, report_manifest, script_result_envelope`
