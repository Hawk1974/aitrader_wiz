---
name: ai_trader_daily_cycle
description: "Runs stage order with deterministic stop conditions and durable daily-cycle reporting."
platforms: [windows]
metadata:
  hermes:
    tags: [ai-trader, alpaca, paper-trading, risk, audit]
---
# Skill: ai_trader_daily_cycle

## Classification

Hybrid Hermes orchestration with Python stage execution.

## Purpose

Runs stage order with deterministic stop conditions and durable daily-cycle reporting.
...
- Script: `scripts/trading/ai_trader_daily_cycle.py`
- Required CLI args: `--cycle-date <YYYY-MM-DD> --stages <CSV>`
- Required schemas/artifacts: `daily_run_state, report_manifest, script_result_envelope`
