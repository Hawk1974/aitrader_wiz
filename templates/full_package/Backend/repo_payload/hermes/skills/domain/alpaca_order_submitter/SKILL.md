---
name: alpaca_order_submitter
description: "Submits only schema-valid, risk-passed, approval-compliant orders. Live mode requires env enablement and valid live credentials."
platforms: [windows]
metadata:
  hermes:
    tags: [ai-trader, alpaca, paper-trading, risk, audit]
---
# Skill: alpaca_order_submitter

## Classification

Python-backed deterministic broker courier.

## Purpose

Submits only schema-valid, risk-passed, approval-compliant orders. Live mode requires env enablement and valid live credentials.
...
- Script: `scripts/integrations/alpaca_order_submitter.py`
- Required CLI args: `--broker-mode paper|live --order-request <path> --risk-decision <path> --approval <optional path>`
- Required schemas/artifacts: `order_request, order_status, script_result_envelope`
