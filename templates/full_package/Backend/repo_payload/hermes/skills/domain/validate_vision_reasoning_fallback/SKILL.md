---
name: validate_vision_reasoning_fallback
description: "Validates Hermes-attached AI artifact behavior where applicable. Does not replace unit/integration tests."
platforms: [windows]
metadata:
  hermes:
    tags: [ai-trader, alpaca, paper-trading, risk, audit]
---
# Skill: validate_vision_reasoning_fallback

## Classification

Validation harness skill with Python runner.

## Purpose

Validates Hermes-attached AI artifact behavior where applicable. Does not replace unit/integration tests.
...
- Script: `scripts/validation/validate_vision_reasoning_fallback.py`
- Required CLI args: `--fixture-dir <path> --output-dir <path>`
